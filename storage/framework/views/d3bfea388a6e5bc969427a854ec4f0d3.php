...
<div class="row">
    <div class="card-header bg-light d-flex flex-wrap align-items-center gap-2">
        <form id="filterForm" method="GET" class="d-flex align-items-center gap-2 w-100">
         ...
         <form id="bulkDeleteForm" action="<?php echo e(route('assetmaster.make_type.bulk-delete')); ?>" method="POST" class="d-inline">
             <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <table class="table table-bordered table-striped" id="makeTypeTable">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $makeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><input type="checkbox" class="rowCheckbox" value="<?php echo e($mk->id); ?>"></td>
...
<div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
    ...
    <div class="text-muted small">
        Showing 
        <?php echo e($makeTypes->firstItem() ?? 0); ?> 
        to 
        <?php echo e($makeTypes->lastItem() ?? 0); ?> 
        of 
        <?php echo e(number_format($makeTypes->total())); ?> entries
    </div>

    
    <div>
        <?php if($makeTypes->hasPages()): ?>
            <nav>
                <ul class="pagination">
                    
                    <?php if($makeTypes->onFirstPage()): ?>
                        <li class="page-item disabled"><span class="page-link">Previous</span></li>
                    <?php else: ?>
                        <li class="page-item"><a class="page-link" href="<?php echo e($makeTypes->previousPageUrl()); ?>" rel="prev">Previous</a></li>
                    <?php endif; ?>

                    
                    <?php
                        $total = $makeTypes->lastPage();
                        $current = $makeTypes->currentPage();
                    ...
                    <?php if($start > 1): ?>
                        <li class="page-item"><a class="page-link" href="<?php echo e($makeTypes->url(1)); ?>">1</a></li>
                        <?php if($start > 2): ?>
                    ...
                    <?php for($i = $start; $i <= $end; $i++): ?>
                        ...
                        <?php else: ?>
                            <li class="page-item"><a class="page-link" href="<?php echo e($makeTypes->url($i)); ?>"><?php echo e($i); ?></a></li>
                        <?php endif; ?>
                    <?php endfor; ?>
                    ...
                    <?php if($end < $total): ?>
                        <?php if($end < $total - 1): ?>
                            <li class="page-item disabled"><span class="page-link">...</span></li>
                        <?php endif; ?>
                        <li class="page-item"><a class="page-link" href="<?php echo e($makeTypes->url($total)); ?>"><?php echo e($total); ?></a></li>
                    <?php endif; ?>

                    
                    <?php if($makeTypes->hasMorePages()): ?>
                        <li class="page-item"><a class="page-link" href="<?php echo e($makeTypes->nextPageUrl()); ?>" rel="next">Next</a></li>
                    <?php else: ?>
...
<script>
    ...
    document.querySelectorAll('#makeTypeTable tbody tr').forEach(row => {
