...
<h5 class="mb-0 mt-2 bg-primary text-white py-2 px-3">
    ...
    <select name="date_filter"
        ...
        <option value="month" <?php echo e(request('date_filter') == 'month' ? 'selected' : ''); ?>>
            This Month
        </option>
        <option value="quarter" <?php echo e(request('date_filter') == 'quarter' ? 'selected' : ''); ?>>
            This Quarter
        </option>
        <option value="half" <?php echo e(request('date_filter') == 'half' ? 'selected' : ''); ?>>
            Half Yearly
        </option>
    </select>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($record->deliverablePlans->count()): ?>
                                            <?php $val = $record->deliverablePlans->pluck('static_subnet_mask')->filter()->implode(', '); ?>
                                            <?php echo e($val !== '' ? $val : '-'); ?>
                                    ...
                                    <td>
                                        <?php if($record->deliverablePlans->count()): ?>
                                            <?php $val = $record->deliverablePlans->pluck('static_vlan')->filter()->implode(', '); ?>
                                            <?php echo e($val !== '' ? $val : '-'); ?>
                                    ...
                                    <td>
                                        <?php if($record->deliverablePlans->count()): ?>
                                            <?php $val = $record->deliverablePlans->pluck('static_gateway')->filter()->implode(', '); ?>
                                            <?php echo e($val !== '' ? $val : '-'); ?>
...
</script><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\report\deliverable\partials\table.blade.php ENDPATH**/ ?>