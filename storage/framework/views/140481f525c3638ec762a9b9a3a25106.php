...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-3">
        <div class="col">
            <a href="<?php echo e(route('finance.reports.profit_loss')); ?>" class="card h-100 text-decoration-none text-dark border-primary shadow-sm">
                <div class="card-body">
        ...
        <div class="col">
            <a href="<?php echo e(route('finance.reports.balance_sheet')); ?>" class="card h-100 text-decoration-none text-dark border-success shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
        ...
        <div class="col">
            <a href="<?php echo e(route('finance.reports.cash_flow')); ?>" class="card h-100 text-decoration-none text-dark border-warning shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\finance\reports\index.blade.php ENDPATH**/ ?>