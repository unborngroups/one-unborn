        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3 mt-3">
                ...
                <select name="office_type" id="office_type" class="form-select" required>
                    ...
                    <option value="head" {{ $client->office_type === 'head' ? 'selected' : '' }}>Head Office</option>
                    <option value="branch" {{ $client->office_type === 'branch' ? 'selected' : '' }}>Branch Office</option>
                </select>
            </div>
            ...
            <div class="col-md-3 mt-3 d-none" id="headOfficeDiv">
                ...
                <select name="head_office_id" class="form-select">
                    ...
                    @foreach($headOffices as $ho)
                        <option value="{{ $ho->id }}" {{ $client->head_office_id == $ho->id ? 'selected' : '' }}>
