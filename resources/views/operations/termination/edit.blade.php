	...
	<div class="card shadow border-0 p-4">
		<form action="{{ route('operations.termination.update', $termination->id) }}" method="POST" enctype="multipart/form-data">
			...
			<div class="row g-3">
                    ...
                    <input type="text" class="form-control" value="{{ $termination->circuit_id }}" readonly></div>
			
                    <div class="col-md-4">
                    <label>Company Name</label>
                    <input type="text" name="company_name" class="form-control" value="{{ $termination->company_name }}" required></div>
				
                    <div class="col-md-4">
                    <label>Address</label>
                    <input type="text" name="address" class="form-control" value="{{ $termination->address }}" required></div>
                    ...
                    <input type="text" name="asset_mac" class="form-control" value="{{ $termination->asset_mac }}"></div>
				
                    <div class="col-md-4">
                    <label>Asset Serial</label>
                    <input type="text" name="asset_serial" class="form-control" value="{{ $termination->asset_serial }}"></div>
                    ...
                    <input type="date" name="date_of_last_renewal" class="form-control" value="{{ $termination->date_of_last_renewal }}"></div>
				
                    <div class="col-md-4">
                        <label>Date of Expiry</label>
                        <input type="date" name="date_of_expiry" class="form-control" value="{{ $termination->date_of_expiry }}"></div>
				
                    <div class="col-md-4">
                        <label>Termination Request Date</label>
                        <input type="date" name="termination_request_date" class="form-control" value="{{ $termination->termination_request_date }}"></div>
				
                    <div class="col-md-4">
                        <label>Termination Requested By</label>
                        <input type="text" name="termination_requested_by" class="form-control" value="{{ $termination->termination_requested_by }}"></div>
				
                    <div class="col-md-4"><label>Termination Request Document</label>
					@if($termination->termination_request_document)
						<a href="{{ asset('storage/'.$termination->termination_request_document) }}" target="_blank">View Document</a>
					@endif
