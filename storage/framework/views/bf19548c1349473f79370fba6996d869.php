...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <!-- <a href="<?php echo e(route('finance.vendor-invoices.create')); ?>" class="btn btn-primary">New Vendor Invoice</a> -->
    </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('finance.vendor-invoices.index')); ?>" class="btn btn-outline-primary btn-sm">View invoices</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('finance.expenses.index')); ?>" class="btn btn-outline-primary btn-sm">View expenses</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('finance.debit-notes.index')); ?>" class="btn btn-outline-primary btn-sm">View notes</a>
                </div>
            </div>
        </div>
    </div>
