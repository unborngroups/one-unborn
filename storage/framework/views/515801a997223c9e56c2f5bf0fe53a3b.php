...
<div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('finance.purchases.print', $purchase->id)); ?>"
            ...
            <a href="<?php echo e(route('finance.purchases.index')); ?>"
               class="btn btn-dark">
                Back
            </a>
        </div>
    ...
    <tr>
        ...
        <!-- RIGHT SIDE -->
        <td style="width:50%; text-align: left;">
            <strong>Place Of Supply</strong> : <?php echo e($feasibility->vandor->state ?? ''); ?> <br>
            <strong>Service ID</strong> : <?php echo e($purchase->service_id ?? ''); ?> <br>
            <strong>UNBORN Service ID/
                Circuit_id</strong> : <?php echo e($purchase->service_id ?? ''); ?> | <?php echo e($deliverablePlan->circuit_id ?? ''); ?> <br>
    ...
    <tr>
        <td class="Bill">
            <strong><?php echo e($feasibility->vandor->vandor_name ?? ''); ?></strong><br>
            <?php echo e($feasibility->vandor->vandor_name ?? ''); ?><br>
            <?php echo e($feasibility->vandor->address1 ?? ''); ?><br>
            <?php echo e($feasibility->vandor->city ?? ''); ?>,
            <?php echo e($feasibility->vandor->state ?? ''); ?> -
            <?php echo e($feasibility->vandor->pincode ?? ''); ?><br>
            GSTIN: <?php echo e($feasibility->vandor->gstin ?? ''); ?>
                    ...
                    <tbody>
                      <?php $__currentLoopData = ($purchase->items ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td></td>
                            <td><?php echo e($deliverables?->purchaseOrder?->arc_per_link ?? '0'); ?></td>
<td><?php echo e($deliverables?->purchaseOrder?->arc_per_link ?? '0'); ?></td>
<td><?php echo e($deliverables?->purchaseOrder?->arc_per_link ?? '0'); ?></td>
