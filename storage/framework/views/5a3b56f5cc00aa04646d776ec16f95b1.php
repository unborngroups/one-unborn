...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-note">
                    Remembered your password? <a href="<?php echo e(route('login')); ?>" style="color:#1f4b84; font-weight:600;">Sign In</a>
                </div>
            </div>
            <div class="auth-side">
        ...
        <!-- New Password --><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>