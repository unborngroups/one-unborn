        ...
        <form action="<?php echo e(route('feasibility.update', $feasibility->id)); ?>" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <select id="link_type" name="link_type" class="form-select" required>
                        ...
                        <option value="new" <?php echo e(old('link_type') == 'new' ? 'selected' : ''); ?>>New Link</option>
                        <option value="existing" <?php echo e(old('link_type') == 'existing' ? 'selected' : ''); ?>>Existing Link</option>
                    </select>
                </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="location_id" class="form-control" value="<?php echo e(old('location_id', $feasibility->location_id ?? '')); ?>">
                </div>

                <!-- Longitude Name -->
                <div class="col-md-3">
                    <label for="form-label fw-semibold">Longitude </label>
                    <input type="text" name="longitude" class="form-control" value="<?php echo e(old('longitude', $feasibility->longitude ?? '')); ?>">
                </div>

                <!-- Delivery Company Name -->
                <div class="col-md-3">
                    <label for="form-label fw-semibold">Latitude</label>
                    <input type="text" name="latitude" class="form-control" value="<?php echo e(old('latitude', $feasibility->latitude ?? '')); ?>">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <?php $staticIpDurationValue = old('static_ip_duration', $feasibility->static_ip_duration); ?>
