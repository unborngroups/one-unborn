    ...
    <div class="card shadow border-0 p-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <div>{{ $user->Date_of_Birth ? \Carbon\Carbon::parse($user->Date_of_Birth)->format('Y-m-d') : '-' }}</div>
            ...
            <div class="col-md-6">
                ...
                <div>{{ $user->Date_of_Joining ? \Carbon\Carbon::parse($user->Date_of_Joining)->format('Y-m-d') : '-' }}</div>
