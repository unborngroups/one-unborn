...
<div class="container py-4">
    <h4 class="text-primary fw-bold mb-3">Feasibility Status - inprogress</h4>
    ...
    <div class="card shadow border-0 p-4">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $inprogressFeasibilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
