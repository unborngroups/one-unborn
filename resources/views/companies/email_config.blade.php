               ...
               value="{{ old('mail_mailer', $setting->mail_mailer ?? 'smtp') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="mail_host" class="form-control"
                            value="{{ old('mail_host', $company->mail_host ?: ($setting->mail_host ?? 'mail.unborn.in')) }}" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="mail_encryption" class="form-select">
                            ...
                            <option value="ssl"
                                {{ old('mail_encryption', $company->mail_encryption ?? optional($setting)->mail_encryption) == 'ssl' ? 'selected' : '' }}>
                                SSL
                            </option>

                            <option value="tls"
                                {{ old('mail_encryption', $company->mail_encryption ?? optional($setting)->mail_encryption) == 'tls' ? 'selected' : '' }}>
                                TLS
                            </option>
                        </select>
