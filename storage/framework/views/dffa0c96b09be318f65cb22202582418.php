...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-lg border-0">
        ...
        <form id="filterForm" method="GET" class="d-flex align-items-center gap-2 w-100">
         ...
         <form id="bulkDeleteForm" action="<?php echo e(route('hr.leavetype.bulk-delete')); ?>" method="POST" class="d-inline">
             <?php echo csrf_field(); ?>
        ...
        <div class="card-body p-0 table-responsive">
            ...
            <table class="table table-hover table-bordered mb-0" id="leaveTypeTable">
                ...
                <tbody>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $leavetypetable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leavetypedata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><input type="checkbox" class="rowCheckbox" value="<?php echo e($leavetypedata->id); ?>"></td>
                            ...
                            <td class="col"><?php echo e($leavetypedata->shortcode ?? '-'); ?></td>
                                <?php
...
<div class="d-flex justify-content-between align-items-center mt-2 flex-wrap">
            <div class="text-muted small">
                Showing
                <?php echo e($leavetypetable->firstItem() ?? 0); ?>

                to
                <?php echo e($leavetypetable->lastItem() ?? 0); ?>

                of
                <?php echo e(number_format($leavetypetable->total())); ?> entries
            </div>
            <div class="ms-auto">
                <nav>
                    <ul class="pagination mb-0">
                        
                        <?php if($leavetypetable->onFirstPage()): ?>
                            <li class="page-item disabled"><span class="page-link">Previous</span></li>
                        <?php else: ?>
                            <li class="page-item"><a class="page-link" href="<?php echo e($leavetypetable->previousPageUrl()); ?>" rel="prev">Previous</a></li>
                        <?php endif; ?>
                        ...
                        <?php if($start > 1): ?>
                            <li class="page-item"><a class="page-link" href="<?php echo e($leavetypetable->url(1)); ?>">1</a></li>
                            <?php if($start > 2): ?>
                        ...
                        <?php for($i = $start; $i <= $end; $i++): ?>
                            ...
                            <?php else: ?>
                                <li class="page-item"><a class="page-link" href="<?php echo e($leavetypetable->url($i)); ?>"><?php echo e($i); ?></a></li>
                            <?php endif; ?>
                        <?php endfor; ?>
                        ...
                        <?php if($end < $total): ?>
                            <?php if($end < $total - 1): ?>
                                <li class="page-item disabled"><span class="page-link">...</span></li>
                            <?php endif; ?>
                            <li class="page-item"><a class="page-link" href="<?php echo e($leavetypetable->url($total)); ?>"><?php echo e($total); ?></a></li>
                        <?php endif; ?>
  
                        
                        <?php if($leavetypetable->hasMorePages()): ?>
                            <li class="page-item"><a class="page-link" href="<?php echo e($leavetypetable->nextPageUrl()); ?>" rel="next">Next</a></li>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views/hr/leavetype/index.blade.php ENDPATH**/ ?>