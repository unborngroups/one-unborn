...
<div style="margin:0 auto; max-width:580px; font-family:'Poppins', system-ui, sans-serif; color:#1f1f1f; background:#f7f3ee; border-radius:24px; padding:32px; box-shadow:0 20px 40px rgba(10,30,60,0.15);">
     ...
     <div style="background:#ffffff; border-radius:20px; padding:28px; border:1px solid #e3e3e3;">
          ...
          <div style="text-align:center;">
               <a href="{{ $resetUrl }}" style="display:inline-flex; align-items:center; justify-content:center; gap:8px; padding:14px 32px; background-image:linear-gradient(135deg,#f8c68e,#1f4b84); color:#fff; border-radius:999px; text-decoration:none; font-weight:700; box-shadow:0 16px 30px rgba(31,75,132,0.35);">
     ...
     <footer style="margin-top:24px; text-align:center; font-size:12px; color:#999; letter-spacing:1px;">© {{ date('Y') }} One-Unborn. All rights reserved.</footer>
</div>
