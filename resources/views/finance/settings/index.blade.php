...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-3">
        <div class="col">
            <a href="{{ route('finance.settings.gst') }}" class="card h-100 text-decoration-none text-dark border-primary shadow-sm">
                <div class="card-body">
        ...
        <div class="col">
            <a href="{{ route('finance.settings.tds') }}" class="card h-100 text-decoration-none text-dark border-success shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
