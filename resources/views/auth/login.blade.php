...
<body>
    ...
    <div class="auth-shell">
        <div class="auth-form">
            ...
            @endif
            <form id="loginForm" action="{{ route('login') }}" method="POST" class="mt-4" autocomplete="off" onsubmit="return false;">
                @csrf
                <div class="mb-3">
                    <div class="input-group">
                        <input type="email" name="email" id="email" class="form-control" placeholder="Official Email" value="{{ old('email') }}" required autofocus>
