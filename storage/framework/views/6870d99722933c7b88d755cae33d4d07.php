...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('finance.sales.index')); ?>" class="btn btn-dark">
            Back
        </a>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('finance.sales.update', $sales->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\finance\sales\edit.blade.php ENDPATH**/ ?>