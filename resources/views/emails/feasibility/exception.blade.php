    ...
    <div class="mail-card">
        ...
        <table class="details-table">
            <tr>
                ...
                <td>{{ $feasibility->feasibility_request_id ?? 'N/A' }}</td>
            </tr>
            <tr>
                <th>Client</th>
                <td>{{ optional($client)->client_name ?? 'N/A' }}</td>
            </tr>
            <tr>
                <th>Type of Service</th>
                <td>{{ $feasibility->type_of_service ?? 'N/A' }}</td>
            </tr>
            <tr>
                <th>No. of Links</th>
                <td>{{ $feasibility->no_of_links ?? 'N/A' }}</td>
            </tr>
        </table>
        ...
        @if(!empty($vendorDetails))
            ...
            <table class="details-table">
                @if(isset($vendorDetails['arc']))
                    <tr>
                        <th>ARC</th>
                        <td>{{ $vendorDetails['arc'] }}</td>
                    </tr>
                @endif
                @if(isset($vendorDetails['otc']))
                    <tr>
                        <th>OTC</th>
                        <td>{{ $vendorDetails['otc'] }}</td>
                    </tr>
                @endif
                @if(isset($vendorDetails['static_ip_cost']))
                    <tr>
                        <th>Static IP Cost</th>
                        <td>{{ $vendorDetails['static_ip_cost'] }}</td>
                    </tr>
                @endif
                @if(isset($vendorDetails['delivery_timeline']))
                    <tr>
                        <th>Delivery Timeline</th>
                        <td>{{ $vendorDetails['delivery_timeline'] }}</td>
                    </tr>
                @endif
            </table>
        @endif
