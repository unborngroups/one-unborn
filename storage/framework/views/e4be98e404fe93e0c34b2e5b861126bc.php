...
<div class="container mt-4">
    ...
    <tr>
        ...
        <!-- RIGHT SIDE -->
        <td style="width:50%; text-align: left;">
            <strong>Place Of Supply</strong> : <?php echo e($feasibility->vendor->state ?? ''); ?> <br>
    ...
    <tr>
        <td class="Bill">
            <strong><?php echo e($feasibility->vendor->vendor_name ?? ''); ?></strong><br>
            <?php echo e($feasibility->vendor->vendor_name ?? ''); ?><br>
            <?php echo e($feasibility->vendor->address1 ?? ''); ?><br>
            <?php echo e($feasibility->vendor->city ?? ''); ?>,
            <?php echo e($feasibility->vendor->state ?? ''); ?> -
            <?php echo e($feasibility->vendor->pincode ?? ''); ?><br>
            GSTIN: <?php echo e($feasibility->vendor->gstin ?? ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\finance\purchases\pdf.blade.php ENDPATH**/ ?>