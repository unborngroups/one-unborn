    ...
    <div class="card shadow border-0 p-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <div><?php echo e($user->Date_of_Birth ? \Carbon\Carbon::parse($user->Date_of_Birth)->format('Y-m-d') : '-'); ?></div>
            ...
            <div class="col-md-6">
                ...
                <div><?php echo e($user->Date_of_Joining ? \Carbon\Carbon::parse($user->Date_of_Joining)->format('Y-m-d') : '-'); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\users\view.blade.php ENDPATH**/ ?>