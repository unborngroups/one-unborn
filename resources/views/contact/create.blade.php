...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0 fw-semibold">Create {{ ucfirst($type) }} Contact</h4>
            ...
            <form action="{{ route('contacts.store', $type) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="contact1" class="form-control" value="{{ old('contact1') }}" placeholder="Enter primary number" required>
                    </div>
                    <div class="col-md-6">
