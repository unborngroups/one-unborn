...
@endif
                ...
                <!-- end Static_ip -->
                        ...
                        {{-- P2P Configuration --}}
                        <div class="card mb-3" id="p2p_section_{{ $i }}" style="display: none;">
                            <div class="card-header bg-warning text-dark">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Username</label>
                                        <input type="text" class="form-control" name="p2p_username_{{ $i }}" 
                                               value="{{ old('p2p_username_'.$i, $plan->p2p_username ?? '') }}">
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Password</label>
                                        <input type="text" class="form-control" name="p2p_password_{{ $i }}" 
                                               value="{{ old('p2p_password_'.$i, $plan->p2p_password ?? '') }}">
                                    </div>

                                    
                                    <!--  -->
                                    <div class="row mb-3" id="tunnel_row_{{ $i }}">
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Tunnel</label>
                                <select name="tunnel_{{ $i }}" id="tunnel_{{ $i }}" class="form-select tunnel-select" data-index="{{ $i }}">
                                    <option value="">Select</option>
                                    <option value="Yes" {{ old('tunnel_'.$i, $plan->tunnel ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No" {{ old('tunnel_'.$i, $plan->tunnel ?? '') == 'No' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3 tunnel-fields" id="tunnel_fields_{{ $i }}" style="display: none;">
                                <label class="form-label">Tunnel Username</label>
                                <input type="text" class="form-control" name="tunnel_username_{{ $i }}" id="tunnel_username_{{ $i }}" value="{{ old('tunnel_username_'.$i, $plan->tunnel_username ?? '') }}">
                            </div>
                            <div class="col-md-4 mb-3 tunnel-fields" id="tunnel_fields_pw_{{ $i }}" style="display: none;">
                                <label class="form-label">Tunnel Password</label>
                                <input type="text" class="form-control" name="tunnel_password_{{ $i }}" id="tunnel_password_{{ $i }}" value="{{ old('tunnel_password_'.$i, $plan->tunnel_password ?? '') }}">
                            </div>
                        </div>
