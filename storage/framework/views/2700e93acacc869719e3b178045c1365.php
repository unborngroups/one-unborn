    ...
    <form method="POST" action="<?php echo e(route('finance.accounts.store')); ?>">
        ...
        <select name="account_group_id" class="form-control mb-2" required>
            ...
            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($g->id); ?>" <?php echo e(old('account_group_id') == $g->id ? 'selected' : ''); ?>>
                    <?php echo e($g->name); ?>
        ...
        <select name="balance_type" class="form-control mb-2" required>
            <option value="Debit" <?php echo e(old('balance_type') == 'Debit' ? 'selected' : ''); ?>>Debit</option>
            <option value="Credit" <?php echo e(old('balance_type') == 'Credit' ? 'selected' : ''); ?>>Credit</option>
        </select>
