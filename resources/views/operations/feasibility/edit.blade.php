                        ...
                        <div class="row g-3 mb-4" id="vendor{{ $i }}_section">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="vendor{{ $i }}_name"
                                    ...
                                    @php
                                    // For existing links, prioritize deliverable data for vendor1
                                    if ($linkType === 'existing' && $i == 1 && isset($deliverable) && $deliverable) {
                                    $value = $deliverable->vendor_name ?? '';
                                    } else {
                                    ...
                                    @endphp
                                    {{-- Debug: --}}
                                    {{-- <span style="color:red">Vendor {{ $i }} value: {{ $value }}</span> --}}
                            ...
                            // For existing links, prioritize deliverable data for vendor1
                            if ($linkType === 'existing' && $i == 1 && isset($deliverable) && $deliverable) {
                            $otc = ''; // OTC not available in DeliverablePlan, use empty
                            } else {
                            ...
                            // For existing links, prioritize deliverable data for vendor1
                            if ($linkType === 'existing' && $i == 1 && isset($deliverable) && $deliverable) {
                            $staticIpCost = ''; // Static IP cost not available in DeliverablePlan, use empty
                            } else {
                            ...
                            // For existing links, prioritize deliverable data for vendor1
                            if ($linkType === 'existing' && $i == 1 && isset($deliverable) && $deliverable) {
                            $deliveryTimeline = $deliverable->feasibilities->feasibility_statuses->delivery_timeline ?? '';
                            } else {
