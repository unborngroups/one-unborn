...
<div class="container">
                ...
                <div class="collapse mt-3" id="importCard">
                    <div class="card border-info">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('asset.import')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
    ...
    <form action="<?php echo e(route('asset.store')); ?>" method="POST">
        ...
        <a href="<?php echo e(route('asset.index')); ?>" class="btn btn-secondary mt-3 float-end">
            <-- Back
        </a>
    </form>
