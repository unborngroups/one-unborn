...
<div class="container-fluid py-4">
                    ...
                    <div class="card-body">
                        <?php for($i = 1; $i <= $linkCount; $i++): ?>
                            ...
                            <div class="row border rounded mb-3 p-2">
                                ...
                                <?php if(!$isSelfVendorType && $vendorForLink): ?>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Vendor Name</label>
                                        <input type="text" class="form-control" value="<?php echo e($vendorForLink->vendor_name ?? ''); ?>" readonly>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Vendor Email</label>
                                        <input type="text" class="form-control" value="<?php echo e($vendorForLink->contact_person_email ?? ''); ?>" readonly>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Vendor Contact</label>
                                        <input type="text" class="form-control" value="<?php echo e($vendorForLink->contact_person_mobile ?? ''); ?>" readonly>
                                    </div>
                                <?php endif; ?>
    ...
    <div class="col-md-3 mb-2">
        ...
        <input type="text" name="payment_account_<?php echo e($i); ?>" class="form-control"
               value="<?php echo e(old('payment_account_'.$i, $plan->payment_account ?? '')); ?>">
    </div>

    <div class="col-md-3 mb-2">
        <label>Account Username</label>
        <input type="text" name="payment_username_<?php echo e($i); ?>" class="form-control"
               value="<?php echo e(old('payment_username_'.$i, $plan->payment_username ?? '')); ?>">
    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="pppoe_username_<?php echo e($i); ?>" class="form-control" placeholder="Enter PPPoE Username" value="<?php echo e(old('pppoe_username_'.$i, $plan->pppoe_username ?? '')); ?>">
                                    </div>
