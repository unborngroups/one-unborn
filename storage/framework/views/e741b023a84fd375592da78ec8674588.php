...
<div class="container-fluid py-4">
	...
	<div class="card shadow border-0 p-4">
		<form action="<?php echo e(route('operations.termination.update', $termination->id)); ?>" method="POST" enctype="multipart/form-data">
			<?php echo csrf_field(); ?>
			...
			<div class="row g-3">
                    ...
                    <input type="text" name="asset_id" class="form-control" value="<?php echo e($termination->asset_id); ?>"></div>
