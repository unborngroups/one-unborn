                            ...
                            <div class="col-md-4 mb-3">
                             ...
                             <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" name="date_of_expiry" 
                                       value="<?php echo e(old('date_of_expiry', $record->date_of_expiry)); ?>" required>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select" id="static_ip_subnet" name="static_subnet_mask">
                                    ...
                                    <?php $__currentLoopData = ['/32','/31','/30','/29','/28','/27','/26','/25','/24']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subnet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($subnet); ?>" <?php echo e(old('static_subnet_mask', $record->static_subnet_mask) == $subnet ? 'selected' : ''); ?>><?php echo e($subnet); ?></option>
                        ...
                        <div class="row" id="static_info_panel" style="display: none;">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="network_ip" name="network_ip"
                                       value="<?php echo e(old('network_ip', $record->network_ip)); ?>" readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="form-label">Gateway</label>
                                <input type="text" class="form-control" id="gateway" name="gateway"
                                       value="<?php echo e(old('gateway', $record->gateway)); ?>" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="subnet_mask" name="subnet_mask"
                                       value="<?php echo e(old('subnet_mask', $record->subnet_mask)); ?>" readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="form-label">Usable IPs</label>
                                <input type="text" class="form-control" id="usable_ips" name="usable_ips"
                                       value="<?php echo e(old('usable_ips', $record->usable_ips)); ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="col-md-3 mb-2">
        ...
        <input type="password" name="payment_password" class="form-control"
               value="<?php echo e($record->payment_password); ?>">
    </div>
</div>
