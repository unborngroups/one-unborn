...
<li class="nav-item ">
    ...
    <details class="sm sidebar-dropdown" <?php echo e(request()->is('sm/feasibility*') || request()->is('sm/purchaseorder*') || request()->is('sm/deliverables*') ? 'open' : ''); ?>>
...
<li class="nav-item ">
    ...
    <details class="operation sidebar-dropdown" <?php echo e(request()->is('operations/asset*') || request()->is('operations/renewals*') || request()->is('operations/feasibility*') || request()->is('operations/deliverables*') || request()->is('operations/purchaseorder*') || request()->is('operations/termination*') ? 'open' : ''); ?>>
        <summary class="nav-link text-white d-flex justify-content-between align-items-center">
            ...
            <li>
                <details <?php echo e(request()->is('finance/sales*') || request()->is('finance/customers*') ? 'open' : ''); ?>>
                    ...
                    <ul class="nav flex-column ms-3 mt-1">
                        ...
                        <li>
                            <a class="nav-link text-white menu-item <?php echo e(request()->is('finance/sales*') && !request()->is('finance/sales/recurring-invoice*') ? 'active' : ''); ?>"
...
<?php endif; ?>
            ...
            <?php if($hr && $hr->can_menu): ?>
                <li class="nav-item ">
                    <details class="hr sidebar-dropdown" <?php echo e(request()->is('hr*') || request()->is('users*') ? 'open' : ''); ?>>
                        <summary class="nav-link text-white d-flex justify-content-between align-items-center ">
...
<?php if(($reportDeliverable && $reportDeliverable->can_menu) || ($reportDeliverableOpen && $reportDeliverableOpen->can_menu) || ($reportDeliverableInProgress && $reportDeliverableInProgress->can_menu) || ($reportDeliverableDelivery && $reportDeliverableDelivery->can_menu)): ?>
<li class="nav-item">
    <details class="report sidebar-dropdown" <?php echo e(request()->is('report/deliverable*') ? 'open' : ''); ?>>
        <summary class="nav-link text-white d-flex justify-content-between align-items-center">
            <span><i class="bi bi-bar-chart"></i> Deliverables Report</span>
            <i class="bi bi-chevron-down arrow-icon"></i>
        </summary>
        <ul class="nav flex-column ms-3 mt-1">
            <?php if($reportDeliverableOpen && $reportDeliverableOpen->can_menu): ?>
            <li>
                <a class="nav-link text-white menu-item <?php echo e($isReportDeliverableOpenActive ? 'active' : ''); ?>" href="<?php echo e(route('report.deliverable.open')); ?>">
                    <i class="bi bi-hourglass-split me-2"></i> Open
                </a>
            </li>
            <?php endif; ?>
            <?php if($reportDeliverableInProgress && $reportDeliverableInProgress->can_menu): ?>
            <li>
                <a class="nav-link text-white menu-item <?php echo e($isReportDeliverableInProgressActive ? 'active' : ''); ?>" href="<?php echo e(route('report.deliverable.inprogress')); ?>">
                    <i class="bi bi-clock-history me-2"></i> In Progress
                </a>
            </li>
            <?php endif; ?>
            <?php if($reportDeliverableDelivery && $reportDeliverableDelivery->can_menu): ?>
            <li>
                <a class="nav-link text-white menu-item <?php echo e($isReportDeliverableDeliveryActive ? 'active' : ''); ?>" href="<?php echo e(route('report.deliverable.delivery')); ?>">
...
<?php endif; ?>
            ...
            <?php if(($template && $template->can_menu) || ($menu && $menu->can_menu) || ($companySettings && $companySettings->can_menu)): ?>
                ...
                <li class="nav-item" >
                    ...
                    <details class="system sidebar-dropdown" <?php echo e(request()->is('emails*') || request()->is('menus*') || request()->is('company-settings*') || request()->is('system-settings*') || request()->is('whatsapp-settings*') ? 'open' : ''); ?>>
...
</style><?php /**PATH C:\xampp\htdocs\one-unborn-main\resources\views/layouts/partials/fullmenu.blade.php ENDPATH**/ ?>