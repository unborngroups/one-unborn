...
<div class="container">
    <h4>Edit Vendor Invoice</h4>

    <form method="POST" action="<?php echo e(route('finance.vendor-invoices.update',$invoice->id)); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-md-4">
                ...
                <select name="vendor_id" class="form-control" required>
                    <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($vendor->id); ?>" <?php echo e($invoice->vendor_id === $vendor->id ? 'selected' : ''); ?>>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <select name="status" class="form-control">
                    <option <?php echo e($invoice->status=='Pending'?'selected':''); ?>>Pending</option>
                    <option <?php echo e($invoice->status=='Paid'?'selected':''); ?>>Paid</option>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" step="0.01" name="gst_amount" class="form-control"
                       value="<?php echo e(old('gst_amount', $invoice->gst_amount)); ?>">
            </div>

            <div class="col-md-4">
                <label>Total Amount</label>
                <input type="number" step="0.01" name="total_amount" id="vendor-invoice-total" class="form-control" readonly
                       value="<?php echo e(old('total_amount', $invoice->total_amount)); ?>">
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views\finance\purchases\vendor_invoices\edit.blade.php ENDPATH**/ ?>