            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <strong>Invoice Date:</strong> {{ $sales->invoice_date }}<br>
                        <strong>Due Date:</strong> {{ $sales->due_date ?? '-' }}
                    </td>
                    <td>
                        <strong>{{ $clientName }}</strong><br>
                        {{ $clientAddress }}<br>
                        {{ $clientCity }} {{ $clientState }} {{ $clientPin }}<br>
                        GSTIN: {{ $client->gstin ?? ($sales->client_gstin ?? '-') }}
                    </td>
                </tr>
            </table>
        </div>
