...
<div class="container py-4 d-flex flex-column align-items-center justify-content-center" style="min-height: 80vh;">
    ...
    <h3 class="mb-3 text-center">Edit Renewal</h3>

    <div class="card shadow border-0 p-4 w-100" style="max-width: 800px;">

        <form action="<?php echo e(route('operations.renewals.update', $renewal->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <select name="deliverable_id" id="deliverable_id" class="form-select" required>
                    ...
                    <?php $__currentLoopData = $deliverables_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($d->deliverable_id); ?>" <?php echo e($renewal->deliverable_id == $d->deliverable_id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\multipleuserpage\resources\views/operations/renewals/edit.blade.php ENDPATH**/ ?>