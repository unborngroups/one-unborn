...
<div class="container py-4">
    ...
    <div class="card shadow border-0 p-4">
        ...
        <tr>
            <th>Company Logo</th>
            <td>
                @if($company->company_logo && file_exists(public_path('images/companylogos/' . $company->company_logo)))
                    <img src="{{ asset('images/companylogos/' . $company->company_logo) }}" alt="Logo" width="100px" height="100px">
                @else
