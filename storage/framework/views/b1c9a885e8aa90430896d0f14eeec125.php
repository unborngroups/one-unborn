<div class="row">
    ...
    <input type="email" name="email_1" id="email_1" class="form-control"
        value="<?php echo e(old('email_1', $company->email_1 ?? '')); ?>" required>
</div>
...
<div class="col-md-6 mb-3">
    ...
    <input type="text" name="alternative_contact" class="form-control"
        value="<?php echo e(old('alternative_contact', $company->alternative_contact ?? '')); ?>">
</div>
...
<?php /**PATH F:\xampp\htdocs\new\multipleuserpage\resources\views/companies/partials/form.blade.php ENDPATH**/ ?>