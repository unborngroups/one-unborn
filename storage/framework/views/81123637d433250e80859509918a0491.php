            ...
            <table class="table table-bordered table-hover align-middle" id="clientTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if((int) ($client->sales_invoice_count ?? 0) > 0): ?>
                            <a href="<?php echo e(route('finance.sales.index', ['client_id' => $client->id])); ?>" class="btn btn-link btn-sm p-0">Click Here</a>
                            <?php else: ?>
                        ...
                        <td class="text-center">
                            <?php if((int) ($client->recurring_invoice_count ?? 0) > 0): ?>
                            <a href="<?php echo e(route('finance.sales.recurring-invoice.index', ['client_id' => $client->id])); ?>" class="btn btn-link btn-sm p-0">Click Here</a>
                            <?php else: ?>
                            <span class="text-muted">N/A</span>
                            <?php endif; ?>
                        </td>
