...
<div class="container mt-1">
    ...
    <div class="mt-1">
        ...
        <div class="row g-4 mt-2">
            <div class="col-md-4 col-sm-6">
                <a href="{{ url('operation/renewals/today') }}" class="text-decoration-none">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="{{ url('operation/renewals/tomorrow') }}" class="text-decoration-none">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="{{ url('operation/renewals/week') }}" class="text-decoration-none">
