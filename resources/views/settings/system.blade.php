        ...
        <form action="{{ route('settings.system.update') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="surepass_api_token" class="form-control" rows="3" placeholder="Enter API Bearer Token for GSTIN verification">{{ $settings->surepass_api_token ?? '' }}</textarea>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <select name="surepass_api_environment" class="form-select">
                        <option value="production" {{ ($settings->surepass_api_environment ?? 'production')==='production' ? 'selected' : '' }}>Production</option>
                        <option value="sandbox" {{ ($settings->surepass_api_environment ?? '')==='sandbox' ? 'selected' : '' }}>Sandbox</option>
                    </select>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="whatsapp_default_number" value="{{ $settings->whatsapp_default_number ?? '' }}" class="form-control" placeholder="e.g. 919876543210">
                ...
                <div class="col-md-6">
                    ...
                    <select name="whatsapp_enabled" class="form-select">
                        <option value="0" {{ !($settings->whatsapp_enabled ?? false) ? 'selected' : '' }}>Disabled</option>
                        <option value="1" {{ ($settings->whatsapp_enabled ?? false) ? 'selected' : '' }}>Enabled</option>
                    </select>
